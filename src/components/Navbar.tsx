      ...
      <div className="max-w-[1600px] mx-auto flex justify-between items-start md:items-center pointer-events-auto">
        ...
        <div className="flex items-center gap-3">
          ...
          <button 
            ...
            className="w-10 h-10 md:w-12 md:h-12 bg-primary-blue text-white rounded-full flex items-center justify-center font-bold text-[10px] md:text-sm transition-transform hover:scale-110 shadow-lg shadow-primary-blue/20 cursor-pointer"
          >
            {lang}
          </button>
        </div>
